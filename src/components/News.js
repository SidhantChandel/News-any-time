...
previousPage =async()=>{
  let url =
  `https://newsapi.org/v2/top-headlines?country=us&category=${this.props.category}&apiKey=343bacff2e9b4e31affb264d8bbc7e21&page=${this.state.page}&pagesize=${this.state.pageSize - 1}
`;
